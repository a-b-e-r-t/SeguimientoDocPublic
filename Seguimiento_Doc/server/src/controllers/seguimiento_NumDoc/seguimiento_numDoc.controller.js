import { obtenerSeguimientoPorNumeroDocumento } from "../../services/seguimiento_NumDoc.services.js";

export const listarSeguimiento = async (req, res) => {
  const { numeroDocumento, usuario, tipoDocumento } = req.params;  

  try {
    const seguimiento = await obtenerSeguimientoPorNumeroDocumento(numeroDocumento, usuario, tipoDocumento);
